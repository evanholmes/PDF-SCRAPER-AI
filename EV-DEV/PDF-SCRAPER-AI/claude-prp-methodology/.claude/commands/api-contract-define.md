...
description: Define API contract between backend and frontend with detailed specifications
arguments: "Feature name for API contract definition"
---
...
4. **Define validation rules**:
   - Backend: Bean Validation annotations (Java) or Pydantic (Python)
   - Frontend: Matching Zod schemas (TypeScript) or Joi (JavaScript)
...
6. **Integration requirements**:
   ...
   - Pagination: Standard pageable format
...
8. **Frontend implementation notes**:
   ...
   // TanStack Query hooks (or SWR)
   // Error handling utilities
   // Loading and error states
   ```

Save this contract as: `workspace/PRPs/contracts/{feature}-api-contract.md`
...
- Analytics (with date ranges, grouping)
